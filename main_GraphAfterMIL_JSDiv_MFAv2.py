...
def main():
    ...
    parser.add_argument('--k', default=10, type=int, help='Number of neighbor in graph generated by DSL')
    ...
    for fold in range(5):
        ...
        optimizer = torch.optim.Adam(milnet.parameters(), lr=0.1 * args.lr * math.sqrt(args.batch_size),
                                     betas=(0.5, 0.9), weight_decay=args.weight_decay)
