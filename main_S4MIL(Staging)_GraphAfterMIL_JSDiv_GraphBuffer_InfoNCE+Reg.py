...
from model.S4MIL.s4MIL_GraphBuffer_InfoNCE_Reg_MFA import S4Model
...
def test(weights, loader, args):
    milnet = S4Model(model_dim=512, state_dim=32, input_dim=args.feats_size, n_classes=len(args.classes), k=args.k,
...
def main():
    ...
    parser.add_argument('--trainval_csv', default='data/tcga_nsclc_staging_trainval_fold.csv', type=str)
