...
def main():
    ...
    parser.add_argument('--trainval_csv', default='data/tcga_brca_staging_trainval_fold(PatchGCN).csv', type=str)
    parser.add_argument('--test_csv', default='data/tcga_brca_staging_test(PatchGCN).csv', type=str)
