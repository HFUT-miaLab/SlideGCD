    ...
    for step, (feat, label) in enumerate(loader):
        ...
        if args.model == 'dsmil':
            ...
            if args.current_epoch < args.warmup_epochs:
                ...
                graph_loss = criterion_main(logits_graph.view(feat.shape[0], -1), label)
...
def main():
    ...
    parser.add_argument('--buffer_size', default=1024, type=int, help='Number of total training epochs')
