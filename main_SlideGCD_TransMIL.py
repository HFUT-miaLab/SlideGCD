...
from model.TransMIL.SlideGCD_TransMIL import SlideGCD_TransMIL
...
def train(model, loader, criterion_main, criterion_dual, optimizer_warmup, scheduler_warmup, optimizer, scheduler,
    ...
    for step, (feat, label) in enumerate(loader):
        ...
        logits_mlp, logits_graph = model(feat)
...
def test(weights, loader, args):
    milnet = SlideGCD_TransMIL(args.feats_size, len(args.classes), args.k, args.buffer_size, args.batch_size).cuda()
