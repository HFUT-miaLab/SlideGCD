...
from model.ABMIL.SlideGCD_ABMIL import SlideGCD_ABMIL
...
def test(weights, loader, args):
    milnet = SlideGCD_ABMIL(args.feats_size, len(args.classes), args.k, args.buffer_size, args.batch_size).cuda()
