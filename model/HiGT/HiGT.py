...
from model.HiGT.Fusion import Fusion_Block
from model.HiGT.GCN import H2GCN
from model.HiGT.MobileHiT import MobileHIT_Block
...
class HiGT(nn.Module):
    ...
    def forward(self, data: Data):
        ...
        if n < self.last_pool_ratio * self.patch_ratio:
            ...
            e = torch.zeros((self.last_pool_ratio * self.patch_ratio - n, c)).to(patch_nodes.device)
