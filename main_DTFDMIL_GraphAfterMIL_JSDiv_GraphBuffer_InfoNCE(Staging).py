...
from model.DTFD_MIL.DTFDMIL_GraphBuffer_InfoNCE_Reg_FIFO_MFA import DTFD_MIL
...
def test(weights, loader, args):
    milnet = DTFD_MIL(args.feats_size, len(args.classes), args.k, args.buffer_size, args.batch_size, args.contrastive_temperature,
