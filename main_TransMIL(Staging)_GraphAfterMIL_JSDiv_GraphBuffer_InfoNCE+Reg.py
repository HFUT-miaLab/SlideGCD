...
from model.TransMIL_GraphBuffer_InfoNCE_Reg_MFA import TransMIL
...
def test(weights, loader, args):
    milnet = TransMIL(args.feats_size, len(args.classes), args.k, args.buffer_size, args.batch_size, args.contrastive_temperature).cuda()
...
def main():
    ...
    parser.add_argument('--num_workers', default=2, type=int, help='Number of total training epochs')
    ...
    parser.add_argument('--reg_weight', default=1.5, type=float)
